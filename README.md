...
- In addition to provided source and constraint files, premade PLL block should be used in Vivado while putting it all together. I2C block operates with 50MHz clock but the synthesizer itself operates with 12MHz clock.
